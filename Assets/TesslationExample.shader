Shader "Unlit/Tessellation"
{
	Properties
	{
		...
		minDist("Tessellation Min Distance", Range(0, 100)) = 1.0
		maxDist("Tessellation Max Distance", Range(0, 100)) = 1.0
	}
		SubShader
	{
...
#include "Tessellation.cginc"
	...
	float4 tessDistance(InternalTessInterp_appdata v0, InternalTessInterp_appdata v1, InternalTessInterp_appdata v2) {
